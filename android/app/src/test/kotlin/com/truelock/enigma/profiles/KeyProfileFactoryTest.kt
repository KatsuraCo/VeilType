...
class KeyProfileFactoryTest {
    ...
    fun create_buildsExpectedProfileShape() {
        ...
        assertEquals("03-17-08-24-11", result.canonicalSequence)
        ...
        assertEquals(32, result.profile.profileHint.size + 24) // smoke check through total sizing
    ...
    fun createFromEmojiSequence_setsEmojiKind() {
        ...
        assertEquals("1f512-1f319-1f98a-26a1-1f9e0", result.canonicalSequence)
